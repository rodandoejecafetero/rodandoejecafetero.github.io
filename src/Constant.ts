export const DEFAULT_IMAGE = `${import.meta.env.VITE_APP_URL}${import.meta.env.VITE_BASE_PATH}${import.meta.env.VITE_STATIC_IMAGE_URL}`;
export const DEFAULT_URL = `${import.meta.env.VITE_APP_URL}${import.meta.env.VITE_BASE_PATH}`;
